...
def fetch_market_data(symbol: str, period: str = "3mo", interval: str = "1d") -> Dict:
    ...
    base_prices = {"^NSEI": 17000.0, "^BSESN": 60000.0, "^NSEBANK": 38000.0}
    ...
    change_pct = ((latest_close - prev_close_for_change) / prev_close_for_change) * 100 if prev_close_for_change else 0.0
